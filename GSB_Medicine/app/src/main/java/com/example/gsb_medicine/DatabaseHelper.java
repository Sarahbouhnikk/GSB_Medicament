...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<Medicament> searchMedicament(String denomination,String formePharmaceutique,String titulaires,String denomination_substance, String voiesAdmin)
    {
    ...
    public int getnbMolecules(int codeCIS) {
        SQLiteDatabase db=this.getReadableDatabase();
        Cursor cursor = db.query(Cursor cursor = db.rawQuery("SELECT COUNT(*) FROM CIS_compo_bdpm WHERE Code_CIS = ?",new String[]{String.valueOf(codeCIS)});
        cursor.moveToFirst();
    ...
    public List<String> getDistinctVoiesAdmin() {
        //initialisation de la liste "voiesAdminList" de type List<String>;
        //lancer la connexion avec la bdd;
        //requete sql -->Voies_dadministration;
        //
    }
    ...
    public List<String> getDistinctVoiesAdmin() { // il y'a différentes voies d'aministration donc c'est pour ça qu'on met "Distinct"
        ...
        voiesAdminList = cursor.getString(0,).toString();
